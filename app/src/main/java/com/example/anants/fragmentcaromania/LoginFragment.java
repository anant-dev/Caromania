...
public class LoginFragment extends Fragment {
   ...
   /* public static LoginFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUname = (TextView) v.findViewById(R.id.username);
        mUpass = (TextView) v.findViewById(R.id.password);
        ...
        mLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getdata();
                if (mUsername.equals("")){
                    Toast.makeText(getContext(),getResources().getString(R.string.username_required),Toast.LENGTH_LONG).show();
                }
                else if(mPassword.equals("")){
                    Toast.makeText(getContext(),getResources().getString(R.string.password_requireed),Toast.LENGTH_LONG).show();
                    ...
                    if ((pref.getString("mUsername", "").equals(mUsername)) &&
                        ...
                        editor.commit();
                        ((MainActivity) getActivity()).showFragment(new DetailsFragment());
                        ...
                        mUname.setText("");
                        mUpass.setText("");
                        Toast.makeText(getContext(),getResources().getString(R.string.login_error), Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
